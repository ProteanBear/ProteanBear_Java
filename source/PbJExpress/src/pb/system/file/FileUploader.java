...
import pb.helper.HttpHelper;
import pb.util.LStrSet;
...
public class FileUploader
{
    ...
    private Map<String,FileInfo[]> fileFields =new HashMap<>();
     ...
     *
     * @param savePath :
     *                 上传文件的保存路径（不包含文件名），参考：{@link FileUploader#setSavePath(String)}
     */
     ...
     * @param acceptTypes
     */
    public final void setAcceptTypes(String[] acceptTypes)
    {
        this.acceptTypes.clear();
    ...
    private void addParamField(String name,
                               String value)
    {
    ...
    private void addFileField(String name,
                              FileInfo value)
    {
    ...
    private void clean(List<FileItemInfo> fiis,
                       int count)
    {
        reset();
    ...
    private Result parseFileField(FileItem item,
                                  String absolutePath,
                                  FileNameGenerator fnGenerator,
                                  List<FileItemInfo> fiis)
    {
    ...
    private void parseFormField(FileItem item,
                                String encoding)
    {
    ...
    public static class FileInfo
    {
        ...
        FileInfo(String uploadFileName,
                 File saveFile)
        {
