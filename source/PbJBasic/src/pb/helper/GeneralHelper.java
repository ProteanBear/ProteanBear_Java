...
public class GeneralHelper
{
    ...
    private static final String[] LONG_DATE_PATTERN            ={"yyyy-MM-dd HH:mm:ss","yyyy/MM/dd HH:mm:ss",
                                                                 "yyyy\\MM\\dd HH:mm:ss","yyyyMMddHHmmss"};
    private static final String[] LONG_DATE_PATTERN_WITH_MILSEC={"yyyy-MM-dd HH:mm:ss.SSS","yyyy/MM/dd HH:mm:ss.SSS",
     ...
     * @return
     */
    public static final String escapeRegexChars(String str,
                                                char... ignores)
    {
        ...
        if(ignores.length>0)
        {
            Set<Character> cs=new HashSet<>(REGEX_CHARS.length);
     ...
     * @return
     */
    public final static int str2Int(String s,
                                    int d)
    {
        int returnVal;
        try
     ...
     * @return
     */
    public final static char str2Char(String s,
                                      char d)
    {
        char returnVal;
        try
    ...
    /**
     * String -> Any，字符串转换为 8 种基础数据类型、及其包装类 {@link java.util.Date}、 或 {@link String}
     *
     * @param <T>
     * @param type : 目标类型的 {@link Class} 对象
     * @param v    : 要转换的字符串
     */
    public static final <T> T str2Object(Class<T> type,
                                         String v)
    {
    ...
    /**
     * String -> Any，如果 handler 为 null 则把字符串转换为 8 种基础数据类型、及其包装类、 {@link java.util.Date} 或
     ...
     * obj 为 {@link java.util.Collection}	: 通过 toArray() 方法返回 Object[] <br>
     * obj 为 {@link Iterable}	: 遍历 {@link Iterable}, 并返回包含其所有元素的 Object[] <br>
     * obj 为 {@link java.util.Iterator}	: 遍历 {@link java.util.Iterator}, 并返回包含其所有元素的 Object[] <br>
     * obj 为 {@link java.util.Enumeration}	: 遍历 {@link java.util.Enumeration}, 并返回包含其所有元素的 Object[]
     * <br>
     ...
     * @return
     */
    public final static Date addDate(Date date,
                                     int value)
    {
     ...
     * @return
     */
    public final static Date addTime(Date date,
                                     int field,
                                     int value)
    {
     ...
     * @return
     */
    public final static String date2Str(Date date,
                                        String format)
    {
        DateFormat df=new SimpleDateFormat(format);
     ...
     *
     * @param str
     * @param includeWidlcard
     * @return
     */
    public static final String regularSQLStr(String str,
     ...
     * @return
     */
    public static final URL getClassResource(Class<?> clazz,
                                             String resPath)
    {
    ...
    /**
     * 获取 clazz 资源环境中 resPath 的 {@link java.io.InputStream}
     *
     * @param clazz
     * @param resPath
     * @return
     ...
     * @return
     */
    public static final String getResourceMessage(String resource,
                                                  String key,
                                                  Object... params)
    {
    ...
    /**
     * 把元素添加到 {@link java.util.Map} 中，不保证线程安全（不替换原值）
     *
     * @param <K>
     * @param <V>
     * @param map
     ...
     * @return
     */
    public static final <K,V> boolean tryPut(Map<K,V> map,
                                             K key,
                                             V value)
    {
    ...
    /**
     * 把元素添加到 {@link java.util.Map} 中，不保证线程安全
     *
     * @param <K>
     * @param <V>
     * @param map
    ...
    /**
     * 把元素添加到 {@link java.util.Map} 中，并保证线程安全（不替换原值）
     *
     * @param <K>
     * @param <V>
     * @param map
     ...
     * @return
     */
    public static final <K,V> boolean syncTryPut(Map<K,V> map,
                                                 K key,
                                                 V value)
    {
    ...
    /**
     * 把元素添加到 {@link java.util.Map} 中，并保证线程安全
     *
     * @param <K>
     * @param <V>
     * @param map
     ...
     * @return
     */
    public static final <K,V> int tryPutAll(Map<K,V> map,
                                            Map<K,V> src)
    {
     ...
     * @return
     */
    public static final <K,V> int syncTryPutAll(Map<K,V> map,
                                                Map<K,V> src)
    {
    ...
    /**
     * 从 {@link java.util.Map} 中删除元素，不保证线程安全
     *
     * @param <K>
     * @param <V>
     * @param map
     ...
     * @return
     */
    public static final <K,V> boolean tryRemove(Map<K,V> map,
                                                K key)
    {
    ...
    /**
     * 从 {@link java.util.Map} 中删除元素，并保证线程安全
     *
     * @param <K>
     * @param <V>
     * @param map
     ...
     * @return
     */
    public static final <K,V> boolean syncTryRemove(Map<K,V> map,
                                                    K key)
    {
        synchronized(map)
        {
