                            ...
                            +'<!--[if(operate!="create"&&limit.remove){]-->'
                                ...
                                +'<!--[if(config.buttons){]-->'
                                    +'<!--[for(var i=0;i<config.buttons.length;i++){]-->'
                                        +'&nbsp;&nbsp;<button id="<!--[=config.buttons[i].id]-->" action-mode="<!--[=config.buttons[i].action]-->" name="<!--[=config.buttons[i].name]-->" data-index="<!--[=index]-->" title="<!--[=config.buttons[i].title]-->" type="button" class="btn btn-<!--[=config.buttons[i].style]--> btn-sm"><span class="glyphicon <!--[=config.buttons[i].icon]-->"><!--[=config.buttons[i].display]--></button>'
                                    +'<!--[}]-->'
                                +'<!--[}]-->'
                            +'<!--[}]-->'
                        +'</div>'
