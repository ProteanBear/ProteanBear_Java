                            ...
                            +'<!--[if(operate!="create"&&limit.remove){]-->'
                                ...
                                +'<!--[if(config.buttons){]-->'
                                    +'<!--[for(var i=0;i<config.buttons.length;i++){]-->'
                                        +'&nbsp;&nbsp;<button id="<!--[=config.buttons[i].id]-->" action-mode="<!--[=config.buttons[i].action]-->" name="<!--[=config.buttons[i].name]-->" <!--[if(config.buttons[i].index){]-->data-index="<!--[=config.buttons[i].index]-->"<!--[}]--> title="<!--[=config.buttons[i].title]-->" <!--[if(config.buttons[i].extra){]-->data-extra="<!--[=(typeof(config.buttons[i].extra)=="function")?config.buttons[i].extra():config.buttons[i].extra]-->"<!--[}]-->type="button" class="btn btn-<!--[=config.buttons[i].style]--> btn-sm"><span class="glyphicon <!--[=config.buttons[i].icon]-->"><!--[=config.buttons[i].display]--></button>'
                                    +'<!--[}]-->'
                                +'<!--[}]-->'
                            +'<!--[}]-->'
                        +'</div>'
